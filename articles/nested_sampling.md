...
This vignette demonstrates how to use the Nested Sampling approach to
obtain the marginal likelihood and a Bayes factor, as described in \[1\]
...
In this experiment, we will use the same DNA alignment to see which DNA
nucleotide substitution model is the better fit.
...
![](nested_sampling_files/figure-html/unnamed-chunk-4-1.png)
...
The Bayes factor is ratio between the marginal (non-log) likelihoods. In
this case, we use the simpler JC69 model as a focus:
...
- \[1\] Maturana, P., Brewer, B. J., Klaere, S., & Bouckaert, R. (2017).
  Model selection and parameter inference in phylogenetics using Nested
  Sampling. arXiv preprint arXiv:1703.05471.
